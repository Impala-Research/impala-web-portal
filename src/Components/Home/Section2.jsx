          ...
          <Grid item xs={12} sm={6}>
            <Paper className={classes.paper}>
              <Typography color="secondary">
                <p>
                  Digital media and digital marketing are moving faster than
                  ever. It’s not only impossible to keep track of all trends
                  it’s even more challenging to understand what trends are
                  matching your target customer.
                </p>
              </Typography>
            </Paper>
          </Grid>
            ...
            <Paper className={classes.paper}>
              <Typography color="secondary">
                <p>
                  ...
                  trends itself (for good reasons!) neuromarketing focuses on
                  the in-depth human behavior by using the latest implicit
                ...
                <p>
                  ...
                  customers. So far, and because of its complexity,
                  neuromarketing analysis was mainly managed by experts that
                  would provide you with selected results.
                </p>{" "}
                <p>Till IMPALA.</p>
              </Typography>
            </Paper>
