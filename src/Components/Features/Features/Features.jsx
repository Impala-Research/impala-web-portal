          ...
          <Paper className={classes.paper}>
            ...
            <Typography color="secondary">
              <ul>
                ...
                <li>
                  what are the best measurement tools for your needs (innovative
                  or classic measurement tools);
                </li>
                <li>
        ...
        <Grid item xs={12} sm={3}>
          <Paper className={classes.paper}>
            <Typography variant="h5" color="primary">
              Our services are designed for helping and guiding you through the
              process of collecting the right data and drawing the right
